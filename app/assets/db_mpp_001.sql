create table users ( id text primary key, version integer not null, realm_id text not null, realm_user_id text not null, last_properties_sync_date datetime, last_contacts_sync_date datetime, last_chats_sync_date datetime, last_user_icons_sync_date datetime );
...
create table chats ( id text primary key, realm_id text not null, realm_chat_id text not null, messages_count integer not null, last_messages_sync_date datetime);
