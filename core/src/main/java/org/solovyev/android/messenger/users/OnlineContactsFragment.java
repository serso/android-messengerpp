...
public class OnlineContactsFragment extends BaseContactsFragment {
	...
	@Nonnull
	@Override
	protected BaseAsyncLoader<UiContact, ContactListItem> createAsyncLoader(@Nonnull BaseListItemAdapter<ContactListItem> adapter, @Nonnull Runnable onPostExecute) {
