...
public class VkMessagesGetHistoryHttpTransaction extends AbstractVkHttpTransaction<List<ChatMessage>> {
    ...
    @Nonnull
    public static HttpTransaction<List<ChatMessage>> forChat(@Nonnull Realm realm, @Nonnull String chatId, @Nonnull User user) {
    ...
    @Nonnull
    public static HttpTransaction<List<ChatMessage>> forChat(@Nonnull Realm realm, @Nonnull String chatId, @Nonnull User user, @Nonnull Integer offset) {
        final VkMessagesGetHistoryHttpTransaction result = new VkMessagesGetHistoryHttpTransaction(realm);
    ...
    @Nonnull
    public static HttpTransaction<List<ChatMessage>> forUser(@Nonnull Realm realm, @Nonnull String userId, @Nonnull User user) {
        final VkMessagesGetHistoryHttpTransaction result = new VkMessagesGetHistoryHttpTransaction(realm);
    ...
    @Nonnull
    public static HttpTransaction<List<ChatMessage>> forUser(@Nonnull Realm realm, @Nonnull String userId, @Nonnull User user, @Nonnull Integer offset) {
        final VkMessagesGetHistoryHttpTransaction result = new VkMessagesGetHistoryHttpTransaction(realm);
