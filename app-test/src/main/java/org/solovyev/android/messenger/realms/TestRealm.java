...
public class TestRealm extends AbstractRealm {
	...
	public TestRealm() {
		super(REALM_ID, R.string.mpp_test_realm_name, R.drawable.mpp_test_icon, TestAccountConfigurationFragment.class, TestAccountConfiguration.class, false, false);
	}
